...
class APIFrame:
    ...
    def remaining_bytes(self):
        ...
        if len(self.raw_data) >= 3:
            ...
            data_len = struct.unpack("> h", raw_len)[0]#[1] # for some weird reason this is the opposite of regular python3
    ...
    def parse(self):
        ...
        # Unpack it
        data_len = struct.unpack("> h", raw_len)[0]#[1] #again somehow micropython needs to use [1] instead of [0]
